...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_map_map__WEBPACK_IMPORTED_MODULE_3__["initMap"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var showMenu = function showMenu() {
  ...
  var navToggle = navMain.querySelector('.navigation__toggle');
...
var smoothScroll = function smoothScroll() {
  var anchorHeaderLinks = document.querySelectorAll('.navigation__link');
  var anchorFooterLinks = document.querySelectorAll('.footer-navigation__link');

  var _iterator = _createForOfIteratorHelper(anchorHeaderLinks),
      _step;
  ...
  var _iterator2 = _createForOfIteratorHelper(anchorFooterLinks),
      _step2;
